...
<form id="sForm" action="addpostform_ok.jsp" method="post" onsubmit="return isValid()">
    <div class="gender_page">
        <label>[ 성별 ]</label><br>
        <label>male </label>
        <input type="radio" name="StudentGender" value="male">
        <label>female </label>
        <input type="radio" name="StudentGender" value="female"><br>
        <br>
    </div>
    ...
    <div class="major">
        ...
        <input type="radio" name="StudentMajor" value="only_computer">
        <label> 전자공학 심화</label>
        <input type="radio" name="StudentMajor" value="only_electronic"><br>
        <br>
    </div>
    ...
    <div class="engineering_certification">
        ...
        <label> 신청 </label>
        <input type="radio" name="IsEngCertification" value="신청">
        <label> 미신청 </label>
        <input type="radio" name="IsEngCertification" value="미신청"><br>
        <br>
    </div>
    ...
    <div class="region">
        ...
        <select name="StudentResident">
            <optgroup label="포항시">
                ...
                <option value ="흥해읍(기숙사)">흥해읍(기숙사)</option>
